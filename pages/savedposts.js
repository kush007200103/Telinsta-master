...
const SavedPosts = ({ user }) => {
  ...
  return (
    <section className="text-gray-600 body-font my-4 mt-20 sm:mt-0 min-h-screen">
      <Head>
      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Posts saved by you</h1>
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Find more content which suits you, save other posts and help us to suggest to content liked you. Some posts that are saved by you are below.</p>
        </div>
        <div className="container px-5 py-4 mx-auto">
          ...
          {posts.length === 0 && <div className='flex flex-col items-center justify-center h-full'>
            ...
            <p className='text-gray-800'>It looks like you saved nothing yet.</p>
            </div>}
          </div>}
        </div>
      </div>
